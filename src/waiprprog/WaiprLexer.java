...
public class WaiprLexer extends Lexer {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Waipr.g:60:5: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
			// Waipr.g:60:7: ( 'a' .. 'z' | 'A' .. 'Z' )+
			{
			// Waipr.g:60:7: ( 'a' .. 'z' | 'A' .. 'Z' )+
			int cnt1=0;
			loop1:
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Waipr.g:62:8: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			// Waipr.g:62:12: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
			{
			// Waipr.g:62:12: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
	...
	public final void mTEXT() throws RecognitionException {
		try {
			int _type = TEXT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Waipr.g:65:5: ( '\"' ( ESC_SEQ |~ ( '\\\\' | '\"' ) )* '\"' )
			// Waipr.g:65:8: '\"' ( ESC_SEQ |~ ( '\\\\' | '\"' ) )* '\"'
			{
			match('\"'); 
			// Waipr.g:65:12: ( ESC_SEQ |~ ( '\\\\' | '\"' ) )*
			loop8:
			while (true) {
				int alt8=3;
	...
	public final void mESC_SEQ() throws RecognitionException {
		try {
			// Waipr.g:74:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
			int alt9=3;
	...
	public final void mOCTAL_ESC() throws RecognitionException {
		try {
			// Waipr.g:81:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt10=3;
	...
	public final void mUNICODE_ESC() throws RecognitionException {
		try {
			// Waipr.g:88:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			// Waipr.g:88:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
			{
			match('\\'); 
			match('u'); 
			mHEX_DIGIT(); 
	...
	public void mTokens() throws RecognitionException {
		// Waipr.g:1:8: ( T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | ID | IE | NUMBER | WS | TEXT )
		int alt11=18;
	...
	protected class DFA11 extends DFA {
		...
		public String getDescription() {
			return "1:1: Tokens : ( T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | ID | IE | NUMBER | WS | TEXT );";
		}
	}
